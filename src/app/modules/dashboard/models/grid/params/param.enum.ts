...
export enum gridParams {
  ...
  'displayGrid' = 'displayGrid',                                          // display background dashboard-grid of rows and columns (enum DisplayGrid)
  ...
  'disableScrollHorizontal' = 'disableScrollHorizontal',                  // enable/disable auto horizontal scrolling when on edge of dashboard-grid
  'disableScrollVertical' = 'disableScrollVertical',                      // enable/disable auto vertical scrolling when on edge of dashboard-grid
  ...
  'margin' = 'margin',                                                    // margin between dashboard-grid items
  'outerMargin' = 'outerMargin',                                          // if margins will apply to the sides of the container
  'outerMarginTop' = 'outerMarginTop',                                    // override top outer margin for dashboard-grid
  'outerMarginRight' = 'outerMarginRight',                                // override right outer margin for dashboard-grid
  'outerMarginBottom' = 'outerMarginBottom',                              // override bottom outer margin for dashboard-grid
  'outerMarginLeft' = 'outerMarginLeft',                                  // override left outer margin for dashboard-grid
  'minCols' = 'minCols',                                                  // minimum amount of columns in the dashboard-grid
  'maxCols' = 'maxCols',                                                  // maximum amount of columns in the dashboard-grid
  'minRows' = 'minRows',                                                  // minimum amount of rows in the dashboard-grid
  'maxRows' = 'maxRows',                                                  // maximum amount of rows in the dashboard-grid
  ...
  'gridType' = 'gridType',                                                // different types for layout for the dashboard-grid
  ...
  'setGridSize' = 'setGridSize',                                          // sets dashboard-grid size depending on content
  'mobileBreakpoint' = 'mobileBreakpoint',                                // if the screen is not wider that this, remove the dashboard-grid layout and stack the items
  'x' = 'x',                                                              // x position if missing will auto position
  'y' = 'y',                                                              // y position if missing will auto position
  'rows' = 'rows',                                                        // number of rows if missing will use dashboard-grid option defaultItemRows
  'cols' = 'cols',                                                        // number of columns if missing will use dashboard-grid option defaultItemCols
